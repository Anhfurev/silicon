...
const products = [
  {
    ...
    description:
      "Системийн давуу тал нь санхүүгийн тайлангуудаас гадна удирдлагын бүртгэлийн нэмэлт тайлангууд, журнал, анхан шатны маягтуудыг программаас хэвлэдэг. Мөн бүртгэлийг олон валютаар зэрэг хөтлөх, байгууллагын доторх нэгж, салбараар орлого, зардлыг ангилан бүртгэж, үр дүнг тодорхойлох боломжтой. Систем нь уян хатан бөгөөд тухайн байгууллагын онцлогт тохирсон тохируулгыг хийх боломжтой.",
    features: [
      "Ерөнхий журнал",
      "Бараа материал",
      "Авлага, Өглөг",
  ...
  },
  {
    ...
    description:
      "Байгууллагын тасралтгүй хэвийн үйл ажиллагааг хангахад шаардлагатай бараа материалын захиалга бэлтгэх, харьцуулах, зохих нөөц бүрдүүлэх, хүлээн авах үйл ажиллагааг автоматжуулсан систем.",
    features: [
  ...
  },
  {
    ...
    description:
      "Хүний нөөц, цалин хөлсний програм нь ажилчдын бүртгэл, албан тушаал, хэлтэс тасгийн бүртгэл болон цалингийн тооцооллыг хийх зориулалттай. Байгууллагын онцлогт тохирсон тохиргоог хэрэглэгч хүссэн хэлбэрээрээ өөрчлөн нийцүүлэх боломжтой.",
